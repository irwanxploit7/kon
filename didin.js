...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
            ...
            break
            case 'groupbot': {
                m.reply('Halo Kak\nGroup XynaBotz: https://chat.whatsapp.com/K1Xam9JsbxDEqprcWyZ2Af\nNOTE : Kalo kakak nya Punya Bot Masukin aja\n\n*_Makasih><_*')
            }
            break
            case 'tqto': {
...
var dev = '6285718828566@s.whatsapp.net'
...
"pollCreationMessage": {
"name": "*_Halo Kk, Saya Owner XynaBotz_*\n\n*_Apakah Kk Nya Puas Dengan Fitur Fitur Yang Ada Di XynaBotz ?_*",
"options": [
	{
			...
			case 'confess':
				...
				header = 'hayyy'
				 ...
				 var button = [{ buttonId: `menfesconfirm`, buttonText: { displayText: `CONFIRM‡` }, type: 1 }, { buttonId: `sewabot`, buttonText: { displayText: `SEWABOT‡` }, type: 1 }]
					didin.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`}, buttons: button, footer: `XynaBotz\nYouTube Channel\nhttps://youtube.com/@xynabotzreal` })
...
didin.sendMessage(m.chat, { react: { text: "⏱️", key: m.key }})
  	anu = `*ꜱᴀʏᴀ xʏɴᴀʙᴏᴛᴢ, ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ ʏᴀɴɢ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴜɴᴛᴜᴋ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜ sᴇsᴜᴀᴛᴜ sᴇᴘᴇʀᴛɪ ᴍᴇᴍʙᴜᴀᴛ sᴛɪᴄᴋᴇʀ ᴅᴀɴ ʟᴀɪɴɴʏᴀ.*`
...
case 'tesrow':{
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Aku Xyna Bot whatsapp multi-device yang dapat membantumu_`,
   footer: "XynaBotz",
   title: "",
...
case 'gamemenu':{
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Berikut Game" Yang Tersedia Di XynaBotz_`,
   footer: "XynaBotz",
   title: "",
   buttonText: "Buka!",
   sections
...
let sections = [
                ...
                didin.sendListMsg(m.chat, `*❏ XynaBotz*
...
https://youtube.com/@XynaBotz

@ XynaBotz`, ' ', ' ', `Buka!`, sections, m)
       }
break
...
- Dana : 085718828566
- PULSA : 085718828566
- Youtube : https://youtube.com/@XynaBotz
